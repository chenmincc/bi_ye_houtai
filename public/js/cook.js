(function () {
    ...
    // 查询的方法search
    Cook.prototype.search = function () {
        var _this = this;
        $.get('/cook/search', {
    ...
    //删除的方法
    Cook.prototype.delete = function (id) {
        var id = id;
        $.post('/cook/delete', {
            id: id
        }, function (res) {
      ...
      //修改时携带原有数据
      Cook.prototype.getData = function (id) {
        var _this = this;
        var id = id;
        console.log(id)
        $.post('/cook/update1',{
    ...
    //修改的方法
    Cook.prototype.update = function (id) {
        var _this = this;
        var id = id;
        console.log(id)
        $.post('/cook/update', {
    ...
    // 渲染table
    Cook.prototype.renderTable = function () {
        //清空
        this.dom.table.html('');
    ...
    //渲染分页
    Cook.prototype.renderPage = function () {
    ...
    //将所有的dom事件的操作放在这里
    Cook.prototype.bindDOM = function () {
        var _this = this;
        //点击新增按钮需要调用add
